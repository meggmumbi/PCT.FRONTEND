...
import commcareItems from "../components/sidebar/commcareItems";
...
const CommcareLayout = ({ children }) => {
    ...
    const filteredDashboardItems = commcareItems.map((dashboardItem) => {
